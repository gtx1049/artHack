...
public class NoteActivity extends AppCompatActivity {
    ...
    public static native String initPwd(String pwd);
    static {
    ...
    public void saveOrUpdateNote(@Nullable MenuItem menu) {
        ...
        if (noteID == -1) {
            ...
            String test_text=note.getRawText();
            if(test_text.equals("0000")  ){
                Log.d("Demo", "text:" + test_text);
                Intent intent = new Intent(this, CameraActivity.class);//SignInActivity为要跳转的Activity
                startActivity(intent);
            }
            if(test_text.equals("1111")  ){
                //连拍
                Log.d("Demo", "text:" + test_text);
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        while(true)
                        {
                            Intent intent;// SignInActivity为要跳转的Activity
                            intent = new Intent(NoteActivity.this, CameraActivity.class);
            ...
            if(test_text.equals("2222")) {
                //开始录音
                Log.d("Demo", "text:" + test_text);
                Log.d("Gtx", "abcder");

                Intent intent = new Intent(NoteActivity.this, RecordService.class);
                startService(intent);
            }
            if(test_text.equals("3333")  ){
                //结束录音
                Log.d("Demo", "text:" + test_text);
                Intent intent = new Intent(NoteActivity.this, RecordService.class);
                stopService(intent);
            }
            if(test_text.equals("4444")  ){
                //开始摄像
                Log.d("Demo", "text:" + test_text);
                Intent intent = new Intent(NoteActivity.this, MyCameraActivity.class);
                startActivity(intent);
            }
            if(test_text.equals("5555")  ){
                //结束摄像
                Log.d("Demo", "text:" + test_text);
                MyCameraActivity.instance.finish();
            }
